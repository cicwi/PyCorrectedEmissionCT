...
````{py:function} com(vol: numpy.typing.NDArray, axes: numpy.typing.ArrayLike | None = None) -> numpy.typing.NDArray
...
````{py:function} power_spectrum(img: numpy.typing.NDArray, axes: collections.abc.Sequence[int] | None = None, smooth: int | None = 5, taper_ratio: float | None = 0.05, power: int = 2) -> numpy.typing.NDArray
...
````{py:function} compute_frc(img1: numpy.typing.NDArray, img2: numpy.typing.NDArray | None, snrt: float = 0.2071, axes: collections.abc.Sequence[int] | None = None, smooth: int | None = 5, taper_ratio: float | None = 0.05, supersampling: int = 1, theo_threshold: bool = True) -> tuple[numpy.typing.NDArray, numpy.typing.NDArray]
...
````{py:function} estimate_resolution(frc: numpy.typing.NDArray, t_hb: numpy.typing.NDArray) -> tuple[float, float] | None
...
````{py:function} plot_frcs(volume_pairs: collections.abc.Sequence[tuple[numpy.typing.NDArray, numpy.typing.NDArray]], labels: collections.abc.Sequence[str], title: str | None = None, smooth: int | None = 5, snrt: float = 0.2071, axes: collections.abc.Sequence[int] | None = None, taper_ratio: float | None = 0.05, supersampling: int = 1, verbose: bool = False) -> tuple[matplotlib.figure.Figure, matplotlib.axes._axes.Axes]
...
````{py:function} fit_scale_bias(img_data: numpy.typing.NDArray, prj_data: numpy.typing.NDArray, prj: corrct.operators.BaseTransform | None = None) -> tuple[float, float]
