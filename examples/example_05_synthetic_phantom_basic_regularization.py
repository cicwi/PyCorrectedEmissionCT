...
fig, ax = plt.subplots()
ax.semilogy(np.squeeze(info_1.residuals_rec_rel), "C0", label=label_1)
ax.semilogy(np.squeeze(info_2.residuals_rec_rel), "C1", label=label_2)
ax.semilogy(np.squeeze(info_3.residuals_rec_rel), "C2", label=label_3)
ax.semilogy(np.squeeze(info_4.residuals_rec_rel), "C3", label=label_4)

ax.semilogy(np.squeeze(info_1.residuals_val_rel), "C0-.", label=(label_1 + " - Cross-Validation"))
ax.semilogy(np.squeeze(info_2.residuals_val_rel), "C1-.", label=(label_2 + " - Cross-Validation"))
ax.semilogy(np.squeeze(info_3.residuals_val_rel), "C2-.", label=(label_3 + " - Cross-Validation"))
ax.semilogy(np.squeeze(info_4.residuals_val_rel), "C3-.", label=(label_4 + " - Cross-Validation"))
