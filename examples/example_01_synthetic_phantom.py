...
if apply_corrections:
    ...
    rec_cpkl = corrct.reconstruct(
        ...
        vol_att_out=vol_att_out, psf=psf, lower_limit=0, iterations=num_cp_iterations) * renorm_factor
    print('- Phantom power: %g, noise power: %g' % (
    ...
    rec_cptvkl = corrct.reconstruct(
        ...
        vol_att_out=vol_att_out, psf=psf, lower_limit=0, lambda_reg=2e-1, iterations=num_cptv_iterations) * renorm_factor
    print('- Phantom power: %g, noise power: %g' % (
